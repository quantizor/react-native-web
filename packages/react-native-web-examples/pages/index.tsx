...
function Link({
  href,
  ...props
}: LinkProps & React.PropsWithChildren<{ style?: RN.TextStyle }>) {
  return (
    <NextLink href={href} passHref>
      <RN.Text {...props} role="link" style={[styles.link, props.style]} />
    </NextLink>
  );
}
    ...
    <RN.View style={styles.app}>
      <RN.View style={styles.header}>
        <RN.Image
          ...
          resizeMode="contain"
          source={{ uri: logoUri }}
          style={styles.logo as RN.ImageStyle}
        />
        <RN.Text style={styles.title}>React Native for Web</RN.Text>
      </RN.View>
      ...
      <RN.View role="list">
        {JSON.parse(process.env.pages || '[]').map((name) => (
          <RN.View key={name} role="listitem" style={styles.listitem}>
