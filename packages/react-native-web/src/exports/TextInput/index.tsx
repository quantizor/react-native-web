...
let TextInput: React.ForwardRefExoticComponent<TextInputProps & React.RefAttributes<HTMLElement & PlatformMethods>> & {State?: typeof TextInputState};

TextInput = React.forwardRef((props: TextInputProps, forwardedRef: React.Ref<HTMLElement & PlatformMethods>) => {
  const {
  ...
  const prevSelection = React.useRef<{ start: number, end: number } | null>(null);
  const prevSecureTextEntry = React.useRef<boolean | null>(null);
