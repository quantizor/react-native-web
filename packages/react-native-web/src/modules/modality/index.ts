...
let previousModality: Modality | undefined | null;
let previousActiveModality: Modality | undefined | null;
let isEmulatingMouseEvents = false;

const listeners = new Set<(value: { activeModality: Modality, modality: Modality }) => void>();
...
export function addModalityListener(
  listener: (value: { activeModality: Modality, modality: Modality }) => void
): () => void {
