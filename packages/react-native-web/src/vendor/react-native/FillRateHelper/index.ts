...
class FillRateHelper {
  _anyBlankStartTime: number | null = null;
  _enabled = false;
  _getFrameMetrics: (index: number, props: FrameMetricProps) => FrameMetrics | null | undefined;
  _info: Info = new Info();
  _mostlyBlankStartTime: number | null = null;
  _samplesStartTime: number | null = null;
  ...
  constructor(
    getFrameMetrics: (index: number, props: FrameMetricProps) => FrameMetrics | null | undefined
  ) {
